namespace DocumentDB.Samples.OrderBy
{
    ...
    public sealed class Program
    {
        ...
        private static readonly ConnectionPolicy ConnectionPolicy = new ConnectionPolicy {
            UserAgentSuffix = " samples-net-orderby/1", 
        ...
        // Twitter API key configs
        private static readonly bool ShouldDownload = false;
        private static readonly string TwitterConsumerKey ="fill in here";
        private static readonly string TwitterConsumerSecret ="fill in here";
        private static readonly string TwitterAccessToken ="fill in here";
        private static readonly string TwitterAccessTokenSecret ="fill in here";
        private static readonly string TwitterSearchText ="DocumentDB";
        private static readonly bool ShouldGetOnlyNewStatuses = false;
        ...
        /// times, and orders them by the order of creation time. 
        /// 
        /// Note how CreatedAt is a DateTime property that's serialized/deserialized as an epoch timestamp value. You can also serialize DateTimes as ISO DateTimes, 
        /// then sort based on the string order.
        /// </summary>
        /// <param name="collection">The collection to run queries against.</param>
        ...
        private void DownloadDataFromTwitter()
        {
            ...
            foreach (Status statusUpdate in twitterClient.GetStatuses(TwitterSearchText, sinceStatusId))
            {
