namespace DocumentDB.Samples.AutoScale
{
    ...
    public sealed class Program
    {
        ...
        private static readonly int CollectionThroughput = int.Parse(ConfigurationManager.AppSettings["StartingCollectionThroughput"]);
        ...
        private async Task RunAsync()
        {
            ...
            int taskCount;
            int degreeOfParallelism = int.Parse(ConfigurationManager.AppSettings["NumberOfTasks"]);
            ...
            {
                tasks.Add(this.InsertDocument(i, this.client, dataCollection, collectionThrottlingHandler, sampleDocument, numberOfDocumentsToInsert));
            }
        ...
        private async Task InsertDocument(int taskId, DocumentClient client, DocumentCollection collection, CollectionThrottlingHandler collectionThrottlingHandler, string sampleJson, long numberOfDocumentsToInsert)
        {
