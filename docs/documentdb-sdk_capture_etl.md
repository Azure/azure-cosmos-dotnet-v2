...
## Here is the steps to start collecting ETL trace file.
...
## You can send the ETL file to us to analyze.  If you want to open it itself, here are the steps:
1.  Download the svcperf at [https://svcperf.codeplex.com/](https://svcperf.codeplex.com/)

 2.  Open svcperf and 


Use svcperf to open it, use the manifest file in Test\Tools\TraceScanner\Manifests
